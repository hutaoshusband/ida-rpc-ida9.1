...
int64_t     start_time;
const char* app_id = "1407895875249770587";

const char* IDAP_comment = "IDA plugin by HUTAOSHUSBAND";  // updated to 9.1
const char* IDAP_help    = "IDA plugin by HUTAOSHUSBAND";  // updated to 9.1
...
namespace callbacks {
    ...
    int idaapi idp_callback( void* /*user_data*/, int notification_code, va_list va )  // updated to 9.1
    {
        ...
        case processor_t::event_t::ev_rename: {
            ...
            // }
            discord_utils::update_discord_presence( start_time );  // updated to 9.1
        } break;
    ...
    int idaapi idb_callback( void* /*user_data*/, int notification_code, va_list va )  // updated to 9.1
    {
        switch ( notification_code ) {
    ...
    int idaapi ui_callback( void* /*user_data*/, int notification_code, va_list va )  // updated to 9.1
    {
    ...
    int idaapi view_callback( void* /*user_data*/, int notification_code, va_list va )  // updated to 9.1
    {
    ...
    int idaapi output_callback( void* /*user_data*/, int notification_code, va_list va )  // updated to 9.1
    {
...
static plugmod_t* idaapi hook_callbacks( )  // updated to 9.1
{
...
static void idaapi unhook_callbacks( )  // updated to 9.1
{
...
static plugmod_t* idaapi IDAP_init( void )  // updated to 9.1
{
    addon_info_t addon;
    addon.id       = "HUTAOSHUSBAND.IDA.RPC";  // updated to 9.1
    addon.name     = "IDA RPC";
    addon.producer = "HUTAOSHUSBAND";                         // updated to 9.1
    addon.url      = "https://www.github.com/HUTAOSHUSBAND";  // updated to 9.1
    ...
    msg( "[%s] v%.2f by HUTAOSHUSBAND loaded\n", IDAP_name, AUTO_VERSION_RELEASE );  // updated to 9.1
    ...
    discord_utils::discord_init( app_id );  // updated to 9.1

    return PLUGIN_KEEP;
}

static void idaapi IDAP_term( void )  // updated to 9.1
{
...
static bool idaapi IDAP_run( size_t arg )  // updated to 9.1
{
